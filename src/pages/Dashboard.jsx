  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen">
        <nav className="fixed top-0 left-0 w-full bg-black bg-opacity-70 p-4 flex justify-center items-center z-50 space-x-6">
          <ScrollLink
      ...
      >
        ...
        {hasVoted ? (
          ...
          <>
            <p className="text-lg mt-4">Vyber jednu z možností:</p>
        ...
        <h3 className="text-2xl font-bold mt-6">Výsledky</h3>
        <ul className="mt-4">
